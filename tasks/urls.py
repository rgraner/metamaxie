...
urlpatterns = [
    ...
    path('remove-scholar/<int:scholar_id>-<int:task_id>/', views.remove_scholar_from_task, name='remove_scholar_from_task'),
    path('help-task/', views.help_task, name='help_task'),
]